    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[300px] lg:h-[400px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
          <h1 className="text-3xl lg:text-5xl font-bold mb-4">Paket Haji</h1>
          <p className="text-lg lg:text-xl text-white/90 max-w-2xl">
            Wujudkan ibadah haji Anda bersama kami dengan layanan terbaik dan bimbingan profesional
          </p>
        </div>
      </section>
      ...
      {/* Info Section */}
      <section className="py-12 px-4 lg:px-8 bg-secondary/10">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-card p-6 rounded-2xl border border-border">
              <h3 className="font-bold text-lg mb-2">Haji Reguler</h3>
              <p className="text-sm text-muted-foreground">
                Program haji dengan kuota pemerintah. Waktu tunggu 20-30 tahun tergantung provinsi.
              </p>
            </div>
            <div className="bg-card p-6 rounded-2xl border border-border">
              <h3 className="font-bold text-lg mb-2">Haji Plus</h3>
              <p className="text-sm text-muted-foreground">
                Program haji dengan fasilitas lebih baik dan waktu tunggu lebih singkat (5-10 tahun).
              </p>
            </div>
            <div className="bg-card p-6 rounded-2xl border border-border">
              <h3 className="font-bold text-lg mb-2">Haji Furoda</h3>
              <p className="text-sm text-muted-foreground">
                Program haji khusus tanpa antrian dengan visa langsung dari Kerajaan Saudi Arabia.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 lg:px-8 bg-primary/5">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl lg:text-3xl font-bold mb-4">Butuh Konsultasi Haji?</h2>
